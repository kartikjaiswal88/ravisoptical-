          ...
          <div className="relative bg-gray-50 rounded-xl sm:rounded-2xl overflow-hidden aspect-square mb-2 sm:mb-3">
            {product.image ? (
              ...
              <div className="w-full h-full flex flex-col items-center justify-center text-gray-300">
                <svg width="64" height="64" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
            ...
            {images.map((img, i) => (
              <button key={i} onClick={() => setImgIdx(i)}
                ...
                <img src={img} alt="" className="w-full h-full object-cover bg-gray-50"
                  onError={e => { e.target.onerror = null; e.target.src = `https://picsum.photos/seed/${product.id}/80/80` }} />
              </button>
            ))}
          </div>
        </div>
